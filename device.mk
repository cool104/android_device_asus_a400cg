...
ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := $(LOCAL_PATH)/blobs/kernel_ww-6.6.3.0
else
...
DEVICE_BASE_BOOT_IMAGE := $(LOCAL_PATH)/blobs/boot_ww-6.6.3.0.img
DEVICE_BASE_RECOVERY_IMAGE := $(LOCAL_PATH)/blobs/recovery_ww-6.6.3.0.img
